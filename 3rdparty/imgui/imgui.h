...
#define IMGUI_FLAGS_ALPHA_BLEND UINT8_C(0x01)
	...
	///
	inline ImTextureID toId(graphics::TextureHandle _handle, uint8_t _flags, uint8_t _mip)
	{
		union { struct { graphics::TextureHandle handle; uint8_t flags; uint8_t mip; } s; ImTextureID id; } tex;
	...
	// Helper function for passing graphics::TextureHandle to ImGui::Image.
	inline void Image(graphics::TextureHandle _handle
		, uint8_t _flags
		, uint8_t _mip
		, const ImVec2& _size
	...
	// Helper function for passing graphics::TextureHandle to ImGui::ImageButton.
	inline bool ImageButton(graphics::TextureHandle _handle
		, uint8_t _flags
		, uint8_t _mip
		, const ImVec2& _size
		, const ImVec2& _uv0     = ImVec2(0.0f, 0.0f)
